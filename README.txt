...
Esta es Big Picture, una plantilla de sitio simple y receptiva de una sola página de HTML5 UP.

Últimamente he estado en una sola página, en parte porque soy vago, pero
sobre todo porque patean traseros para experimentar. En este caso, Big Picture
hace un uso intensivo de mi "desplazamiento progresivo" (provisionalmente nombrado y que pronto se lanzará)
y los complementos jQuery de "scrollwatch" para lograr algunos efectos interesantes a medida que
desplazarse por la página. Además de dichos efectos interesantes, Big Picture
también incluye una bonita galería de estilo lightbox, estilo para elementos de página básicos,
y código completamente comentado para su placer de edición (¡con instrucciones!
-- vea abajo).

Muchas gracias a mis buenas amigas Felicia Simion (ineedchemicalx.deviantart.com)
y Michael Domaradzki (md.photomerchant.net) por permitirme usar sus increíbles
fotos en la demostración de Big Picture *.

(* = ¡No incluido! Solo para usar con mi propia demostración en el sitio, así que NO
descargar y / o usar cualquiera de los trabajos de Felicia o Michael sin su explícito
¡permiso!)

AJ
aj@lkn.io | @ajlkn

PD: ¿No está seguro de cómo hacer funcionar ese formulario de contacto? Prueba Formspree.io (es increíble).
